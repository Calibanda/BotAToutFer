...
class Discussion(commands.Cog):
    ...
    async def ptdrtki(self, ctx):
        response = (
            ...
            + f"Alors pour ta culture je suis le grand {self.bot.user.mention}, le bot Discord qui fait tout, même le café !"
        )
    ...
    async def crepes(self, ctx):
        response = (
            ...
            + f"- {random.randint(300, 500)} g de beurre fondu\n"
            + "1/ Dans un grand récipient, mélangez les œufs, le lait ainsi que la farine.\n"
            ...
            + "7/ Huilez une crêpière très chaude et formez des crêpes à l'aide d'une petite louche.\n"
